...
function CredentialsPage() {
  ...
  const arrSkills = [
    { strName: 'React Architecture', numUser: boolJustCompleted ? 92 : 70, numMarket: 85, color: '#f43f5e' },
    { strName: 'Django API Design', numUser: boolJustCompleted ? 85 : 80, numMarket: 80, color: '#10b981' },
