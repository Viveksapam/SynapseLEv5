...
const QuizEngineGate = ({ strTitle, boolHasLimit, numMaxAttempts, numAttemptsUsed, boolLockedOut, strCooldownText, onStart }) => (
  <div className="quiz-container">
    ...
    <div className="quiz-gate">
      ...
      {boolLockedOut ? (
        ...
        <button className="nav-btn quiz-start-btn" onClick={onStart}>BEGIN ASSESSMENT</button>
      )}
    </div>
  </div>
);

QuizEngineGate.propTypes = {
