...
from llm_services.llm_audit import _MODEL_NAME, LlmAuditError, _require_api_key, _parse_json_response
from llm_services.llm_audit_mock import analyze_post_thread_mock
...
8. If the post makes no falsifiable claim, say so plainly and respond in kind to what it IS
   (a thought, a question, a vibe) - do not manufacture a critique.
